...
local includes = {
	...
	"scripts.ascensions.3_less_special_rooms",
	"scripts.ascensions.4_items_dont_grant_health",
	"scripts.ascensions.5_full_heart_damage_ch3",
	"scripts.ascensions.6_room_may_not_gain_charge",
	"scripts.ascensions.7_higher_shop_prices",
	"scripts.ascensions.8_worse_beggars",
	"scripts.ascensions.9_weaker_soul_hearts",
	"scripts.ascensions.10_extra_boss_room",
	"scripts.ascensions.11_broken_hearts",
